...
def create_tfrecords_format(dataset_name, database_file, image_file_root, cats_to_include=[],
    ...
    for im in tqdm(images):
        ...
        image_data['id'] = dataset_name + '~' + str(im['id'])
        ...
        for ann in im_id_to_anns[im['id']]:
            ...
            image_data['object']['id'].append(ann['image_id'])
...
if __name__ == '__main__':
    my_vis_data = create_tfrecords_format(
        'KNPS',
        '../../../json/val/result_COCO.json',
        '../../../images/val',
        cats_to_include=['__', 'WD', 'WP', 'BG', 'RD']
    )
    with open('formatted_val.json', 'w', encoding='utf-8') as f:
        json.dump(my_vis_data, f, ensure_ascii=False)
